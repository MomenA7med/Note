package com.example.momen.noteretrofit;
...
import com.example.momen.noteretrofit.View.NotesAdapter;
import com.example.momen.noteretrofit.model.Note;
import com.example.momen.noteretrofit.model.User;
import com.example.momen.noteretrofit.network.ApiClient;
import com.example.momen.noteretrofit.network.ApiService;
import com.example.momen.noteretrofit.utils.MyDividerItemDecoration;
import com.example.momen.noteretrofit.utils.PrefUtils;
import com.example.momen.noteretrofit.utils.RecyclerTouchListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        apiService = ApiClient.getClint(getApplicationContext()).create(ApiService.class);
                ...
                apiService
                        ...
                        .subscribeWith(new DisposableSingleObserver<User>() {
                            ...
                            public void onSuccess(User user) {
                                ...
                                PrefUtils.storeApiKey(getApplicationContext(), user.getApi_key());
    ...
    private void showNoteDialog (final boolean shoudUpdate,final Note note,final int position)
    {
        ...
        dialogTitle.setText(!shoudUpdate ? getString(R.string.lbl_new_note_title) : getString(R.string.lbl_edit_note_title));
        if (shoudUpdate && note != null) {
            inputNote.setText(note.getNote());
        }
        builder
                .setCancelable(false)
                .setPositiveButton(shoudUpdate ? "update" : "save", new DialogInterface.OnClickListener() {
